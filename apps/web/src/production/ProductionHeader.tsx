  ...
  return (
    <header className="flex min-h-20 items-center justify-between gap-4 border-b border-[var(--border-subtle)] px-5 py-4 max-md:flex-col max-md:items-start max-md:px-4">
      ...
      <div className="flex gap-2 max-md:w-full">
        <button className="min-h-11 rounded border border-[var(--border-strong)] px-4 text-sm text-[var(--fg-secondary)] hover:bg-[var(--bg-subtle)] disabled:opacity-50 max-md:flex-1" type="button" onClick={onOpenSettings}>模型设置</button>
